...
public class Horario {
    ...
    // Objetos relacionados (opcional, para exibicao)
    private Turma turma;
    ...
    // Construtor para cadastro (sem id) - SEM sala e observacoes
    ...
    public String toString() {
        ...
        return dia_semana + " - " + horario_inicio + " as " + horario_fim + " (" + disciplinaNome + ")";
    }
}